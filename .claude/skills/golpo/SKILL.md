...
`.claude/skills/golpo/scripts/golpo.py` (relative to the repository root).
Always invoke it via `python3` with that path.
...
```bash
python3 .claude/skills/golpo/scripts/golpo.py check
```
...
```bash
python3 .claude/skills/golpo/scripts/golpo.py auth --key "<KEY>"
```
...
```bash
python3 .claude/skills/golpo/scripts/golpo.py upload /path/to/file.mp3
```
...
```bash
python3 .claude/skills/golpo/scripts/golpo.py generate \
