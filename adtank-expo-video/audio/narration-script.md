...
| 6 | 0:42.5 | 8.4秒 | 採用診断サービス、アドターン・フォー・エイチアール。戦略レポートそのものを出力します。 |
| 7 | 0:51.7 | 7.8秒 | トップパフォーマーの脳を、武器に。アドターン・フォー・エイチアール。デモはブースで。（rate +8%） |
...
# → adelay 1000 / 7300 / 16000 / 24900 / 33800 / 42500 / 51700 ms で amix
