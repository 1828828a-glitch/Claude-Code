...
// 86秒間まわり続け、シーンごとにカメラと明度だけが変わる。
// シーン境界（グローバルフレーム）:
// L1 0-315 / L2 315-715 / L3 715-905 / Q1 905-1155 / Q2 1155-1450 / Q3 1450-1690 / L7 1690-2150 / L8 2150-2590
...
const WAYPOINTS: Array<[number, number, number, number]> = [
  ...
  [2150, 0, 10.6, 0.24],
  [2150 + T, 2.3, 10.5, 0.22], // L8前半 右奥（書面の反対）
  [2478, 2.3, 10.5, 0.22],
  [2478 + T, 0, 9.8, 0.32], // L8エンドカード センター奥
  [2590, 0, 10.0, 0.32],
];
